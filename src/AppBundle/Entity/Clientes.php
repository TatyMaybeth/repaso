...
class Clientes
{
     ...
     * Add cliente
     *
     * @param \AppBundle\Entity\CliPed $cliente
     *
     * @return Clientes
     */
    public function addCliente(\AppBundle\Entity\CliPed $cliente)
    {
     ...
     * @param \AppBundle\Entity\CliPed $cliente
     */
    public function removeCliente(\AppBundle\Entity\CliPed $cliente)
    {
